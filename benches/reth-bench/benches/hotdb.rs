...
use bench_shared::{make_key, shuffled_indices, DB_MAX_SIZE, LARGE_N, LOOKUP_COUNT, MEDIUM_N, SEED};
use criterion::{
    criterion_group, criterion_main, BatchSize, BenchmarkId, Criterion, Throughput,
};
use rand::{Rng, SeedableRng, rngs::SmallRng};
use reth_db::{
    mdbx::{DatabaseEnv, DatabaseEnvKind, DatabaseArguments, SyncMode},
    ClientVersion,
};
use reth_db_api::{
            ...
            |(_dir, db)| {
                ...
                for block in 100u64..110 {
...

                    {
                        ...
                        tx.put::<tables::Headers>(block, make_header(block)).unwrap();
                        tx.commit().unwrap();
                    }
                }
            },
